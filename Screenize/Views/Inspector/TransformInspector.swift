            ...
            VStack(spacing: 8) {
                HStack {
                    ...
                    Slider(value: Binding(
                        ...
                        set: { keyframe.center = NormalizedPoint(x: $0, y: keyframe.center.y); onChange?() }
                    ), in: 0...1)
                ...
                HStack {
                    ...
                    Slider(value: Binding(
                        ...
                        set: { keyframe.center = NormalizedPoint(x: keyframe.center.x, y: $0); onChange?() }
                    ), in: 0...1)
...
struct CenterPointPicker: View {
    ...
    @Binding var center: NormalizedPoint
    ...
    private func updateCenter(from location: CGPoint, in size: CGSize) {
        ...
        center = NormalizedPoint(x: newX, y: newY)
        onChange?()
    }
}
